...
refer to the documentation at https://godoc.org/go.elastic.co/apm/v2/[godoc.org/go.elastic.co/apm],
...
Please refer to the documentation at https://godoc.org/go.elastic.co/apm/v2#Tracer[godoc.org/go.elastic.co/apm#Tracer]
for details. The configuration methods are primarily prefixed with `Set`, such as
https://godoc.org/go.elastic.co/apm/v2#Tracer.SetLogger[apm#Tracer.SetLogger].
