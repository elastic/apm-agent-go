...
refer to the documentation at https://pkg.go.dev/go.elastic.co/apm/v2[pkg.go.dev/go.elastic.co/apm/v2],
...
Please refer to the documentation at https://pkg.go.dev/go.elastic.co/apm/v2#Tracer[pkg.go.dev/go.elastic.co/apm/v2#Tracer]
for details. The configuration methods are primarily prefixed with `Set`, such as
https://pkg.go.dev/go.elastic.co/apm/v2#Tracer.SetLogger[apm#Tracer.SetLogger].
