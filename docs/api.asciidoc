...
The duration of the transaction is calculated as the amount of time
...
You can add additional context to describe any transaction reporting and error events.
...
SetSpan associates the error and the transaction of the given span.
