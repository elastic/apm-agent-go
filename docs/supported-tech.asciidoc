...
We support https://github.com/redis/go-redis[go-redis],
https://github.com/redis/go-redis/v9/tree/v9.0.3[v9.0.3] and also v6, v8.
We provide helper functions for reporting Redis commands as spans.

See <<builtin-modules-apmgoredisv9, module/apmgoredisv9>> for more information
