...
https://golang.org/pkg/database/sql/[database/sql] drivers. The high-performance https://github.com/valyala/fasthttp[valyala/fasthttp]
...
https://golang.org/pkg/net/http/#Request.Context[net/http.Context] / https://pkg.go.dev/github.com/valyala/fasthttp#RequestCtx[fasthttp.RequestCtx].
