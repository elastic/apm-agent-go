...
To report bugs, please create an Issue on the https://github.com/elastic/apm-agent-go[apm-agent-go] GitHub repository. For tips on contributing code fixes or enhancements, please see the https://github.com/elastic/apm-agent-go/blob/main/CONTRIBUTING.md[contributing guide] in the code repository.
