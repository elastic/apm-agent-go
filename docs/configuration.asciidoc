...
Adapt the Elastic APM Go agent to your needs with one of the following methods--in descending order of precedence:
...
The timeout for requests made to your Elastic APM Server. Timeouts will be disabled when set to zero or a negative value.
